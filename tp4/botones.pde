...
void mouseClicked() {
  if (mouseX > porX(botones[pantalla][0][1]) && mouseX < porX(botones[pantalla][0][2]) && mouseY > porY(botones[pantalla][0][3]) && mouseY < porY(botones[pantalla][0][4])) {
    pantalla = botones[pantalla][0][0];
  } else if (botones[pantalla][1].length > 0) {
    if (mouseX > porX(botones[pantalla][1][1]) && mouseX < porX(botones[pantalla][1][2]) && mouseY > porY(botones[pantalla][1][3]) && mouseY < porY(botones[pantalla][1][4])) {
