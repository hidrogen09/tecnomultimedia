class Controlador {
  ...
  Controlador(PApplet pApplet) {
    ...
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX (width/2-70), resize.PorcentajeY (480), 0);
    //creditos = new Creditos(textos.getTextoParaPantallaCreditos(pantalla, 0), 0, posY);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, creditos, null);



    //Creo la pantalla 3 (inicio de aventura)
    pantalla = 2;
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX (width/2-100), resize.PorcentajeY (480), 3);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, null, null); 
    ...
    pantalla = 5;
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX(width/2-100), resize.PorcentajeY (480), 6);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, null, null); 
    ...
    pantalla = 8;
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX (width/2-70), resize.PorcentajeY (480), 9);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, null, null);

    //Creo la pantalla 10 (invita gente al castillo)
    pantalla = 9;
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX (width/2-100), resize.PorcentajeY (480), 10);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, null, null); 
    ...
    pantalla = 11;
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX (width/2-100), resize.PorcentajeY (480), 12);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, null, null); 

    //Creo la pantalla 13 (llega barba)
    pantalla = 12;
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX (width/2-100), resize.PorcentajeY (480), 17);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, null, null); 

    //Creo la pantalla 14 (abre la puerta)
    pantalla = 13;
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX (width/2-100), resize.PorcentajeY (480), 14);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, null, null); 
    ...
    pantalla = 15;
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX (width/2-100), resize.PorcentajeY (480), 16);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, null, null); 
    ...
    pantalla = 17;
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX (width/2-100), resize.PorcentajeY (480), 18);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, null, null); 

    //Creo la pantalla 19 (barba se re enoja)
    pantalla = 18;
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX (width/2-100), resize.PorcentajeY (480), 19);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, null, null); 

    //Creo la pantalla 20 (la mata)(perderia en el juego)
    pantalla = 19;
    boton3 = new Boton(textos.getTextoParaPantallaBoton(pantalla, 0), resize.PorcentajeX (width/2-100), resize.PorcentajeY (480), 0);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton3, null, null, null);
